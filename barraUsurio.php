				...
				<ul class="nav ace-nav pull-right">
					...
					<li class="green">
						...
						<ul class="pull-right dropdown-navbar dropdown-menu dropdown-caret dropdown-closer">
							...
							<li>
								<a href="#">
									<img alt="Alex's Avatar" class="msg-photo" src="avatar.png">
									<span class="msg-body">
							...
							<li>
								<a href="#">
									<img alt="Susan's Avatar" class="msg-photo" src="avatar3.png">
									<span class="msg-body">
										<span class="msg-title">
							...
							<li>
								<a href="#">
									<img alt="Bob's Avatar" class="msg-photo" src="avatar4.png">
									<span class="msg-body">
										<span class="msg-title">
					...
					<li class="light-blue user-profile">
						<a class="user-menu dropdown-toggle" href="#" data-toggle="dropdown">
							<img alt="Jason's Photo" src="img/user.jpg" class="nav-user-photo">
							<span id="user_info">
